...
def create_python_dataset():
    with open('../../test_corpus/python_assignment_dataset.py', 'w') as f:
...
def create_java_dataset():
    with open('../../test_corpus/java_assignment_dataset.java', 'w') as f:
        for i in range(1, 100):
            random_name = ''.join(random.choices(
                string.ascii_uppercase + string.ascii_lowercase, k=6))
            random_operator = random.choice(operators)
...
def create_cpp_dataset():
    with open('../../test_corpus/cpp_assignment_dataset.cpp', 'w') as f:
        for i in range(1, 100):
            random_name = ''.join(random.choices(
                string.ascii_uppercase + string.ascii_lowercase, k=6))
            random_operator = random.choice(operators)
